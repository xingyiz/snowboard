...
//int STD_SKI_CPU_1_MODE=1;
//int STD_SKI_CPU_2_MODE=1;
...
extern int ski_tests_init(int current_cpu, int total_cpus);
...
char* ski_parse_env(){
	...
	//ski_parse_int_env_variable("USC_SKI_CPU_1_MODE", &STD_SKI_CPU_1_MODE, 1);
	//ski_parse_int_env_variable("USC_SKI_CPU_2_MODE", &STD_SKI_CPU_2_MODE, 1);
	...
	printf("[CPU_AFFI=%d] calling ski_tests_init\n", STD_SKI_CPU_AFFINITY);
	//printf("SKI_CPU_1_MODE=%d\n", STD_SKI_CPU_1_MODE);
	//printf("SKI_CPU_2_MODE=%d\n", STD_SKI_CPU_2_MODE);
	ski_tests_init(STD_SKI_CPU_AFFINITY, STD_SKI_TOTAL_CPUS);
	printf("[CPU_AFFI=%d] finishing ski_test_init\n", STD_SKI_CPU_AFFINITY);
	return "";
}
